...
class ProductTemplateMapperTest {
    ...
    public void productTemplateEntityToProductTemplateDto() throws Exception {
        ...
        assertEquals(NR_OF_FIELDS, productTemplateDto
                .getFieldsdto()
                .size());
        assertEquals(NAME_FIELD_1, productTemplateDto
                .getFieldsdto()
                .get(0)
                .getFieldname());
    }
    ...
    public void productTemplateDtoToProductTemplateResponseModel() throws Exception {
        ...
        assertEquals(NR_OF_FIELDS, productTemplateResponseModel
                .getFields()
                .size());
        assertEquals(NAME_FIELD_1, productTemplateResponseModel
                .getFields()
                .get(0)
                .getFieldname());
    }
